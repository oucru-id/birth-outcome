...
(async () => {
  ...
  for (const name of ['pregnancy_sources', 'sigizi_sources', 'epus_sources', 'sigizi_deletion_exclusion', 'other_sources', 'simrs_facility_sources', 'kobo_sources', 'core_reporting', 'pregnancy_first_seen', 'raw_sources_to_reporting']) {
